-- Make event-media bucket public so the live view slideshow can render media
UPDATE storage.buckets SET public = true WHERE id = 'event-media';

-- Public RPC: list approved, uploaded items for a given gallery token
