ALTER TABLE public.event_media_galleries
  ADD COLUMN IF NOT EXISTS slideshow_enabled boolean NOT NULL DEFAULT false;
...
BEGIN
  UPDATE public.event_media_galleries
     SET slideshow_enabled = _enabled, updated_at = now()
