...
-- Drop old 7-param version of add_guest_public
DROP FUNCTION IF EXISTS public.add_guest_public(uuid, text, text, text, text, text, text);

-- Drop and recreate get_public_event_with_data_secure with added_by_guest_id
