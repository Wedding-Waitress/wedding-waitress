...
-- Add hero_image_config column to live_view_module_settings
ALTER TABLE public.live_view_module_settings
ADD COLUMN IF NOT EXISTS hero_image_config jsonb DEFAULT NULL;

-- Drop and recreate get_public_event_with_data_secure to include hero_image_config
