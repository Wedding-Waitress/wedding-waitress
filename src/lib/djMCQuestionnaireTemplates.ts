...
export const DEFAULT_SECTION_TEMPLATES: DefaultSectionTemplate[] = [
  {
    ...
    items: [
      { row_label: 'Prelude Songs (As Guests Arrive)', has_music_url: true },
      { row_label: 'Processional Songs (Bridal Party Entrance)', has_music_url: true },
      { row_label: 'Bride Walking Down the Aisle', has_music_url: true },
      { row_label: 'Interlude (During Signing)', has_music_url: true },
      { row_label: 'Recessional (Exit Song)', has_music_url: true },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { row_label: 'Bridal Party Dance', has_music_url: true },
      { row_label: 'Cake Cutting Song', has_music_url: true },
      { row_label: 'Bouquet Toss Song', has_music_url: true },
      { row_label: 'Garter Toss Song', has_music_url: true },
      { row_label: 'Last Dance', has_music_url: true },
    ],
  },
  {
    section_type: 'dinner',
