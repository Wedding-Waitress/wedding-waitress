...
export const DEFAULT_SECTION_TEMPLATES: DefaultSectionTemplate[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { row_label: 'Cake Cutting & Toast Song', has_music_url: true },
      { row_label: 'First Bridal Dance', has_music_url: true },
      { row_label: 'Second Bridal Dance with Guests', has_music_url: true },
      ...
      { row_label: 'Farewell Circle / Arch Song', has_music_url: true },
    ],
  },
  {
    section_type: 'dinner',
