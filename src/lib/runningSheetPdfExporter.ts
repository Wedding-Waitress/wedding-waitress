...
const generateRunningSheetHTML = (
  ...
  return `
    <div style="width:794px;background:#fff;font-family:Arial,Helvetica,sans-serif;<div style="width:794px;background:#fff;font-family:Arial,Helvetica,sans-serif;padding:40px 29px 0 40px;box-sizing:border-box;">;box-sizing:border-box;">
      <!-- Header -->
