...
const generateRunningSheetHTML = (
  ...
  return `
    <div style="width:794px;background:#fff;font-family:Arial,Helvetica,sans-serif;<div style="width:794px;background:#fff;font-family:Arial,Helvetica,sans-serif;padding:40px 60px 0 60px;box-sizing:border-box;">;box-sizing:border-box;">
      <!-- Header -->
