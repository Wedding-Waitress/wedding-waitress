...
const generateRunningSheetHTML = (
  ...
  return `
    <div style="width:794px;background:#fff;font-family:Arial,Helvetica,sans-serif;<div style="width:794px;background:#fff;font-family:Arial,Helvetica,sans-serif;padding:40px 19px 0 19px;box-sizing:border-box;">;box-sizing:border-box;">
      <!-- Header -->
