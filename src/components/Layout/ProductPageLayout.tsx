...
export const ProductPageLayout: React.FC<ProductPageLayoutProps> = ({
  ...
  const url = `https://weddingwaitress.netlify.app${location.pathname}`;
  ...
  const breadcrumbJsonLd = {
    ...
    '@type': 'BreadcrumbList',
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://weddingwaitress.netlify.app/' },
      { '@type': 'ListItem', position: 2, name: 'Products', item: 'https://weddingwaitress.netlify.app/products' },
  ...
  const webPageJsonLd = {
    ...
    isPartOf: {
      ...
      url: 'https://weddingwaitress.netlify.app',
    },
  };
