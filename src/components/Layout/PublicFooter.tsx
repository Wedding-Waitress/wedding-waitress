...
export const PublicFooter: React.FC<PublicFooterProps> = ({ showBackToTop = false }) => <footer className="ww-public-dashboard-background px-4 py-14 text-white">
