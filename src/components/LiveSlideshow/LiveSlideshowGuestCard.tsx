...
interface LiveSlideshowGuestCardProps {
  guest: Guest;
  showRsvp?: boolean;
  showDietary?: boolean;
}

export const LiveSlideshowGuestCard: React.FC<LiveSlideshowGuestCardProps> = ({ guest, showRsvp = true, showDietary = true }) => {
      ...
      <CardContent className="p-8">
          ...
          {guest.table_no ? (
            <div className="flex items-center justify-between p-4 bg-primary/5 rounded-lg border border-primary/20">
              <div className="flex items-center">
                ...
                <div>
                  <p data-live-slideshow-label className="text-lg font-semibold text-foreground">
              ...
              {guest.seat_no && (
                <div className="text-right">
                  <p data-live-slideshow-label className="text-lg font-semibold text-primary">
                    Seat {guest.seat_no}
                  </p>
                </div>
              )}
        ...
        {showRsvp && (
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <span data-live-slideshow-label className="text-lg font-medium text-foreground">RSVP Status:</span>
            </div>
            <Badge data-live-slideshow-status className={`px-4 py-2 text-lg font-medium ${getRSVPColor(guest.rsvp)}`}>
        ...
        {showDietary && guest.dietary && guest.dietary !== 'NA' && guest.dietary !== 'None' && (
          <div className="flex items-start p-3 bg-blue-50 rounded-lg border border-blue-200">
            ...
            <div>
              <p data-live-slideshow-label className="text-sm font-medium text-blue-800 mb-1">Dietary Requirements:</p>
