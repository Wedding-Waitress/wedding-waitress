        ...
        <div className="px-4 sm:px-6 py-4 border-b border-card-border bg-white">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex-1 min-w-0">
              <h3 className="text-xl sm:text-2xl font-medium text-[#7248e6] truncate">
              ...
              <div className="flex items-start gap-2 mt-3">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground">
                  {isMobile ? "Create & manage events here." : "Start here by creating & managing your events, then create the number of tables you want in the next \"Tables\" page."}
                </p>
              </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <Button variant="default" size={isMobile ? "sm" : "sm"} className="rounded-full flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white touch-target" onClick={() => setCreateModal(true)}>
