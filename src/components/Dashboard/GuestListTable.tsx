            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              ...
              <div className="flex items-center space-x-2">
                <TooltipProvider>
                  ...
                  <div className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-300 h-9 px-3 bg-gradient-primary text-primary-foreground hover:scale-105 transform pointer-events-none">
