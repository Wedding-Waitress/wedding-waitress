        ...
        <div className="px-3 sm:px-6 py-4">
          ...
          <div className="flex flex-col xl:flex-row xl:items-start xl:justify-between gap-4 sm:gap-6 mb-4 sm:mb-6">
            ...
            <div className="w-full">
              ...
              {/* Guest Live View APP Protection. You have full control in what your guest see. — informational banner */}
              <div className="bg-card border border-border rounded-xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.10)] p-4 mb-4 flex flex-col md:flex-row md:items-center gap-4">
                <div className="flex items-start gap-3 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-base font-bold text-primary mb-1">Guest Live View APP Protection. You have full control in what your guest see.</h3>
