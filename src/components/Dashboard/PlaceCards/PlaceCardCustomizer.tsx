                ...
                <div className="border-[1.5px] border-primary rounded-xl bg-white p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <Select
                        value={
                          currentSettings.guest_name_bold
                            ? "bold"
                            : currentSettings.guest_name_italic
                              ? "italic"
                              : currentSettings.guest_name_underline
                                ? "underline"
                                : "default"
                        }
                        onValueChange={(value) => {
                ...
                <div className="border-[1.5px] border-primary rounded-xl bg-white p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <Select
                        value={
                          currentSettings.info_bold
                            ? "bold"
                            : currentSettings.info_italic
                              ? "italic"
                              : currentSettings.info_underline
                                ? "underline"
                                : "default"
                        }
                        onValueChange={(value) => {
              ...
              <div className="space-y-4">
                ...
                <div className="border-[1.5px] border-primary rounded-xl bg-white p-4 space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Enable Text Edit Mode above, then drag text elements directly on the card preview to reposition
                    them.
                  </p>
                </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(value: "none" | "decorative" | "full" | "full_front" | "full_back") =>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <Label htmlFor="bg-names-toggle" className="text-sm">
                      Add background behind names
                    </Label>
                    <Switch
                      id="bg-names-toggle"
                  ...
                  <div className="flex items-center justify-between">
                    <Label htmlFor="bg-table-seats-toggle" className="text-sm">
                      Add background behind tables & seats
                    </Label>
                    <Switch
                      ...
                      className={
                        currentSettings.background_behind_table_seats ? "" : "border border-[#967A59] rounded-full"
                      }
                    />
                  </div>
                </div>
                ...
                {(currentSettings.background_image_type === "decorative" ||
                  currentSettings.background_image_type === "full" ||
                  currentSettings.background_image_type === "full_front" ||
                  currentSettings.background_image_type === "full_back") && (
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground mt-1 text-center">
                        Want more design freedom? Click 'Edit with Canva' to customise your place card using Canva.
                        After downloading your design as PNG or PDF, return here and upload it to Wedding Waitress.
                      </p>
                      ...
                      {currentSettings.background_image_url && (
                        <div className="mt-2 space-y-2">
                          ...
                          <div className="flex items-center gap-2 text-sm text-muted-foreground">
                            ...
                            <span>
                              We recommend using a horizontal (landscape orientation) photo or Logo for best result.
                            </span>
                          </div>
              ...
              <div className="space-y-4">
                <div className="p-4 border-2 border-accent-foreground rounded-xl space-y-3">
                  ...
                  <Textarea
                    ...
                    value={localMassMessage}
                    onChange={(e) => setLocalMassMessage(e.target.value)}
                    rows={3}
                  />
                ...
                <div className="p-4 border-2 border-accent-foreground rounded-xl space-y-3">
                  ...
                  {guests.length > 0 && (
                    <Button onClick={saveIndividualMessages} variant="success" className="w-full rounded-full">
