...
export const QRCodeMainCard: React.FC<QRCodeMainCardProps> = ({
  ...
  return <Card className="ww-box h-full">
      <CardHeader>
        <CardTitle className="flex items-center gap-2 my-0">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center space-x-2 mx-0 my-[20px]">
            <Input id="qr-event-url" value={eventUrl} readOnly className="flex-1" placeholder="https://…/live-view/{eventId}" />
            <Button id="btn-copy-url" variant="outline" size="sm" onClick={handleCopyUrl} className="shrink-0">
        ...
        <div className="space-y-3 p-4 bg-green-50 border border-green-200 rounded-lg">
          ...
          {/* Event Information */}
          {selectedEvent && <div className="flex items-center justify-between text-xs text-green-700 mx-px">
              <div className="flex items-center gap-2">
        ...
        <div className="space-y-4">
            ...
            <Card className="ww-box">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="space-y-2">
                  <Button onClick={handleLiveView} className="w-full" disabled={!selectedEvent?.slug}>
                    <ExternalLink className="h-4 w-4 mr-2" />
                    Open Live View
                  </Button>
                  <Button variant="outline" onClick={handleCopyLink} className="w-full" disabled={!selectedEvent?.slug}>
