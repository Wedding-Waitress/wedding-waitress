    ...
    <Card className="dashboard-card p-5 space-y-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <h3 className="dashboard-section-title text-base">Password protection</h3>
          <p className="text-sm text-muted-foreground">
            Require guests to enter a password before they can upload or view the live slideshow. The QR code and link stay the same.
          </p>
        </div>
      </div>
