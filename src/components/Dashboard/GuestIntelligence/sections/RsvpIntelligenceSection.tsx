  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 gap-2">
        ...
        <InsightCard label="Pending" value={ins.pending} tone={ins.pending > 0 ? 'warning' : 'neutral'} />
        <InsightCard label="Declined" value={ins.declined} />
        <InsightCard label="Response Rate" value={`${ratePct}%`} hint={`${ins.attending + ins.declined} of ${ins.total} responded`} tone="info" />
      </div>
    </IntelligenceSection>
  );
};
