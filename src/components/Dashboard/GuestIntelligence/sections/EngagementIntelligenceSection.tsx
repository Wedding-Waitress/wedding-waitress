...
export const EngagementIntelligenceSection = ({ guests }: { guests: Guest[] }) => {
  ...
  return (
    ...
    >
      {guests.length === 0 ? (
        <EmptyHint>Add guests to see engagement coverage.</EmptyHint>
      ) : (
        <>
          <div className="grid grid-cols-2 gap-2.5 mb-3">
            ...
            <InsightCard
              ...
              value={ins.inviteNotSent}
              tone={ins.inviteNotSent ? 'warning' : 'neutral'}
            />
            ...
            <InsightCard
              label="Missing Both"
              value={ins.withNeither}
              tone={ins.withNeither ? 'warning' : 'neutral'}
            />
          </div>
