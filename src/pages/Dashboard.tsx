  ...
  return <SidebarProvider>
    ...
    <div className={`dashboard-shell relative min-h-screen dashboard-surface w-full mobile-contain ${activeTab === 'my-events' ? 'ww-myevents-brown' : ''}`}>
      ...
      <div className="flex pt-16 sm:pt-14 md:pt-16 w-full">
        ...
        <main className={`flex-1 w-full px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 min-w-0 overflow-x-hidden${BROWN_OUTLINE_TABS.has(activeTab) ? ' ww-brown-outline-core ww-heading-system' : ''}${BROWN_OUTLINE_TABS.has(activeTab) || activeTab === 'photo-video-gallery' ? ' ww-solid-text' : ''}`}>
