...
import { LiveSlideshowGuestCard } from '@/components/LiveSlideshow/LiveSlideshowGuestCard';
import { normalizeRsvp } from '@/lib/rsvp';
import styles from './LiveSlideshowView.module.css';
...
export const LiveSlideshowView: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          console.log('Live Slideshow realtime guest update received:', payload);
      ...
      .subscribe((status) => {
        console.log(`Live Slideshow realtime subscription status: ${status}`);
      });
  ...
  // Filter guests with no minimum character requirement for the Live Slideshow.
      ...
      <div className="bg-white/10 backdrop-blur-sm border-b border-white/20">
        <div className="w-full px-4 sm:px-8 py-6">
          <div className="text-center flex flex-col items-center gap-2">
            ...
            {event.date && (
              <div data-live-slideshow-body className="flex items-center justify-center text-white/90 text-base sm:text-lg">
            ...
            {event.venue_address && (
              <div data-live-slideshow-body className="text-white/80 text-sm sm:text-base">{event.venue_address}</div>
            )}
            {(event.start_time || event.finish_time) && (
              <div data-live-slideshow-body className="text-white/80 text-sm sm:text-base">
                ...
                <div className="text-center py-8">
                  ...
                  <div className="max-w-md mx-auto p-6 bg-primary/10 rounded-xl">
                    <div className="flex items-center justify-center gap-3 mb-3">
                      ...
                      <span data-live-slideshow-label className="font-semibold text-primary">Need Help?</span>
                    </div>
