...
export const Products = () => {
  ...
  return <div className="ww-public min-h-screen"><SeoHead title="All Wedding Planning Products | Wedding Waitress" description="Explore all 15 connected Wedding Waitress products for guest lists, RSVPs, seating, stationery, event-day planning and guest photo sharing." canonicalPath="/products" jsonLd={itemList} /><Header /><main>
    <section className="ww-section ww-section-cream text-center"><div className="ww-container max-w-4xl"><p className="ww-eyebrow mb-4">The complete platform</p><h1 className="ww-display">Fifteen tools. One connected wedding plan.</h1><p className="ww-lead mx-auto mt-6 max-w-3xl">Plan guests and seating, create stationery and venue references, coordinate the day and bring guest memories together without managing a stack of disconnected products.</p></div></section>
