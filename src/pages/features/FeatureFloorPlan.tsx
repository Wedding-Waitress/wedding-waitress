...
export const FeatureFloorPlan = () => {
  ...
  return (
    <FeaturePageLayout
      ...
      seoSections={[
        { heading: t('fp.floorPlan.seo1Heading'), text: <Trans i18nKey="fp.floorPlan.seo1Text" ns="landing" components={[<Link to="/qr-code-seating-chart" className={linkClass} />]} /> },
        { heading: t('fp.floorPlan.seo2Heading'), text: <Trans i18nKey="fp.floorPlan.seo2Text" ns="landing" components={[<Link to="/qr-code-seating-chart" className={linkClass} />]} /> },
