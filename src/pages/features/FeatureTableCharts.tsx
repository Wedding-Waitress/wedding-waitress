...
export const FeatureTableCharts = () => {
  ...
  return (
    <FeaturePageLayout
      ...
      seoSections={[
        { heading: t('fp.tableCharts.seo1Heading'), text: <Trans i18nKey="fp.tableCharts.seo1Text" ns="landing" components={[<Link to="/full-seating-chart" className={linkClass} />]} /> },
        { heading: t('fp.tableCharts.seo2Heading'), text: <Trans i18nKey="fp.tableCharts.seo2Text" ns="landing" components={[<Link to="/tables" className={linkClass} />]} /> },
        { heading: t('fp.tableCharts.seo3Heading'), text: t('fp.tableCharts.seo3Text') },
      ]}
      relatedFeatures={[
        { label: t('fp.tableCharts.related1'), href: "/full-seating-chart" },
        { label: t('fp.tableCharts.related2'), href: "/tables" },
        { label: t('fp.tableCharts.related3'), href: "/name-place-cards" },
      ]}
    />
  );
};