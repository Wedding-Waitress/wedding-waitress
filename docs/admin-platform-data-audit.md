...
| Kiosk Live View | `live_view_module_settings`, `events`, `guests`, `tables` | `event_id` | Overview, Events | Configuration present and current event totals | Fully synchronised configuration/data. Kiosk sessions and screen impressions are not reliably recorded. |
