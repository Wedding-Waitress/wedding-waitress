...
const entries = [
  ...
  { path: '/events/weddings', changefreq: 'monthly', priority: '0.9' },
  { path: '/events/engagements', changefreq: 'monthly', priority: '0.8' },
  { path: '/events/birthdays-parties', changefreq: 'monthly', priority: '0.8' },
  { path: '/events/corporate-events', changefreq: 'monthly', priority: '0.8' },
  { path: '/events/christmas-seasonal-events', changefreq: 'monthly', priority: '0.8' },
  { path: '/events/memorials-celebrations-of-life', changefreq: 'monthly', priority: '0.8' },
  ...
  { path: '/seating-chart-signs', changefreq: 'monthly', priority: '0.9' },
