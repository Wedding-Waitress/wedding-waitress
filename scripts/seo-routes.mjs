...
export const seoRoutes = [
  ...
  page("/products", "All Wedding Planning Products | Wedding Waitress", "Explore fifteen connected Wedding Waitress tools for guests, seating, stationery, venue references, event-day planning and shared memories.", "Fifteen tools. One connected wedding plan."),
  ...
  page("/kiosk-live-view", "Wedding Kiosk Guest & Seating Lookup | Wedding Waitress", "Let wedding guests search for their table or seat on a venue touchscreen, tablet, laptop, desktop kiosk or entrance display.", "Kiosk Live View", { schema: "Product" }),
